...
[![Platform: Windows](https://img.shields.io/badge/platform-Windows-0078D6.svg?logo=windows&logoColor=white)](#平台支持)
[![Release: v0.1.2](https://img.shields.io/badge/release-v0.1.2-brightgreen.svg?logo=github&logoColor=white)](https://github.com/superheroYu/sshnet-share/releases/latest)
...
<sub><a href="https://github.com/superheroYu/sshnet-share/releases/latest"><b>下载</b></a> · <a href="#界面截图">界面截图</a> · <a href="#功能">功能</a> · <a href="#架构概览">架构</a> · <a href="#开发">开发</a> · <a href="#文档">文档</a></sub>
...
<table>
  <tr>
    ...
    <td><code>v0.1.2</code> &mdash; <a href="https://github.com/superheroYu/sshnet-share/releases/latest">前往 Releases 下载 Windows 安装包</a></td>
  </tr>
  <tr>
    <td><b>仓库地址</b></td>
...
- **多配置反向隧道** &mdash; 让不同本机代理同时经由一台或多台 SSH 服务器路由。
- **Windows 原生信任链** &mdash; 使用 Windows OpenSSH、Credential Manager 和应用专属 `known_hosts` 管理 Host Key。
- **完整可观测性** &mdash; 支持筛选的日志、运行状态、通知历史和脱敏诊断导出。
- **托盘优先的桌面体验** &mdash; 浅色 / 深色主题、可选静默自启，以及签名的 Tauri updater 流程。
...
SSHNet Share `v0.1.2` **仅支持 Windows**。当前的安装包、更新器流程、凭据存储和 OpenSSH 行为检查都面向 Windows 桌面环境。
